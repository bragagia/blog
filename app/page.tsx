  ...
  return (
    ...
    <div className="bg-white p-8 md:p-12 max-w-4xl mx-auto font-sans text-gray-700 leading-relaxed">
      ...
      <header className="mb-12">
        <div className="flex flex-col md:flex-row items-start md:items-end justify-between md:mt-8 mb-8">
          ...
          <div className="flex flex-col">
            ...
            <div>
              <p className="prata italic text-sm md:max-w-xs my-2 text-justify text-gray-700">
      ...
      <section className="mb-10">
        ...
        <SectionContent>
          <p>
            Full-Stack Developer & Entrepreneur in Paris, fluent in React.js,
            React Native, Node.js, and Golang. My mission? Turning cool ideas
            into seriously impactful digital products.
          </p>
          <p>
            My superpower comes from having worn both PM and CTO hats – I get
            the big picture strategy *and* the nitty-gritty code.
          </p>
          <p>
            What I bring to your project: <br />
            <span className="mr-1 font-semibold">→</span>Taking complex web &
            mobile apps (PWA, SSR, React Native) from zero to one, end-to-end.{" "}
            <br />
            <span className="mr-1 font-semibold">→</span>Mastery of the modern
            tech stack: Cloud (AWS, Vercel), CI/CD, Docker, databases (Postgres,
            NoSQL), Microservices, queues, comprehensive testing... and more!{" "}
            <br />
            <span className="mr-1 font-semibold">→</span>Clear communication and
            strong teamwork vibes (fully bilingual French/English).
          </p>
          <p>
            Ready to inject some energy and serious tech/product know-how into
      ...
      <section className="mb-10">
        {/* Section Title - Use josefin class */}
        <SectionTitle>Side Projects & Initiatives</SectionTitle>
        <SectionContent>
          <ul className="space-y-3 text-gray-800 font-light">
            <li>
              <strong className="font-medium text-gray-800">
                Sunrise Briefing:
              </strong>
              AI-generated daily news summaries delivered each morning. Explores
              LLMs for content synthesis and delivery automation.
            </li>

            <li>
              <strong className="font-medium text-gray-800">YouWise:</strong>
              Spaced repetition system (SRS) application focused on learning
              business and self-development book summaries. Features learning
              algorithms and progress tracking.
            </li>

            <li>
              <strong className="font-medium text-gray-800">Todobeast:</strong>
